...
class ChangeNumberPage extends StatefulWidget {
  ...
  ChangeNumberPage(this.configKey, this.hinttext);

  @override
  _ChangeNumberPageState createState() =>
      _ChangeNumberPageState(configKey, hinttext);
}
...
class _ChangeNumberPageState extends State<ChangeNumberPage> {
  ...
  _ChangeNumberPageState(this.configKey, this.hinttext);
                ...
                children: [
                  ...
                  ElevatedButton(
                      onPressed: () async {
                        Map<String, dynamic> configData =
                            await ServiceClass.readConfigFile();
                        configData[configKey] = double.parse(_controllerText.text)/100;
                        await ServiceClass.writeConfigFile(configData);
                        Navigator.of(context).pop();
                      },
                      child: Text('OK')),
